...
const CASES: Array<{ label: string; facts: Parameters<typeof checkPlausibility>[0] }> = [
  {
    label: '3 beds, 23 m² (the real bug)',
    facts: { beds: 3, baths: 1.5, sqft: 23, price: 50_000 },
  },
  ...
  {
    label: 'large but plausible house',
    facts: { beds: 6, baths: 3, sqft: 240, price: 12_000_000 },
  },
]
